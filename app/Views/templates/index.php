...
<div class="p-4 md:p-8 max-w-7xl mx-auto flex flex-col gap-6 md:gap-8 pb-20">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between shrink-0 gap-4">
        ...
        <a href="<?= site_url('templates/create') ?>" class="w-full sm:w-auto justify-center bg-[#FFB800] hover:bg-[#e6a600] text-emerald-950 text-sm font-black py-3 px-6 rounded-xl shadow-md shadow-amber-950/20 transition-all active:scale-[0.98] flex items-center gap-2 cursor-pointer">
