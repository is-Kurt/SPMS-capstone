...
<div class="h-full flex flex-col bg-bg">
    ...
    <div class="flex items-center gap-3">
        <a href="<?= site_url('documents?folder_id=' . $doc['document_folder_id']) ?>">
        ...
        <div class="flex items-center gap-4">
            ...
            <button type="button" onclick="saveWith(() => submit('submission', 'submissions'))" class="bg-accent hover:bg-accent-hover text-white text-xs font-bold py-2.5 px-6 rounded-lg shadow-lg shadow-accent/20 transition-all active:scale-[0.98] cursor-pointer">
                Submit
            </button>
        </div>
    </div> 
