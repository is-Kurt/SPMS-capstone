...
<div class="h-full flex flex-col bg-bg">
    ...
    <div class="flex-none flex items-center justify-between py-2 px-3 sm:px-6 bg-bg gap-2 sm:gap-4 print-hide">
        ...
        <div class="flex items-center gap-2 sm:gap-4 shrink-0">
            ...
            <!-- Official Accomplishment Report (AR) Button -->
            <a href="<?= site_url('document/' . $doc['id'] . '/accomplishment-report') ?>" 
               target="_blank"
               class="inline-flex items-center gap-1.5 px-2.5 sm:px-3.5 py-2 sm:py-2.5 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-slate-950 text-[10px] sm:text-xs font-black rounded-lg transition-all cursor-pointer shadow-sm active:scale-[0.98] print-hide"
               title="Open official CSC & BSU formatted Accomplishment Report (AR) in a new tab">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-slate-950" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
                <span class="hidden md:inline">AR Report</span>
                <span class="hidden sm:inline md:hidden">AR</span>
            </a>
